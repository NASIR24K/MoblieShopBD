...
<html>
	...
	<tr>
		<td>Category Name : </td>
		<td>
			<?php print Combo('cat_id',"SELECT * FROM category",$row[0]); ?>
		</td>
	</tr>
	<tr>
		<td>Product ID : </td>
		<td>
			<input type="text" id="product_id" name="product_id" value="<?php print $row[1]; ?>" readonly >
		</td>
	</tr>
	<tr>
		<td>Product Name : </td>
		<td>
			<input type="text" id="product_name" name="product_name" value="<?php print $row[2]; ?>" >
		</td>
	</tr>
	<tr>
		<td>BRAND : </td>
		<td>
			<input type="text" id="product_brand" name="product_brand" value="<?php print $row[3]; ?>" >
		</td>
	</tr>
	<tr>
		<td>MODEL : </td>
		<td>
			<input type="text" id="product_model" name="product_model" value="<?php print $row[4]; ?>" >
		</td>
	</tr>
	<tr>
		<td>Description : </td>
		<td>
			<textarea id="product_description" name="product_description"><?php print $row[5]; ?></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="2">
